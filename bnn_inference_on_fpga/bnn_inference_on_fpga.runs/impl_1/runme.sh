...
HD_PWD='C:/Mac/Home/Documents/Projects/FPGA-BNN-Project/bnn_inference_on_fpga/bnn_inference_on_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bnn_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bnn_top.tcl -notrace
