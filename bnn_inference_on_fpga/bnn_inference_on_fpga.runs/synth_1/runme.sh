...
HD_PWD='C:/Mac/Home/Documents/Projects/FPGA-BNN-Project/bnn_inference_on_fpga/bnn_inference_on_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bnn_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bnn_top.tcl
